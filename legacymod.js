...
func:function()
{
    ...
    */
    ...
    new G.Res({
        name:'spoiled food',
        desc:'Bacteria and mold have overrun this piece of food rendering it nearly disgusting, foul, and nearly inedible.//[spoiled food] is eaten when no other [food] is available, in a last-ditch effort to fend off starvation. It will decay away into nothing over time.',
        icon:[3,7],
        visible:true,
    ...
    new G.Res({
        name:'grain',
        desc:'[grain,Grain]is harvested from cereal plants such as or [wheat], and is commonly used to make baked goods. Not nice to eat raw.',
        icon:[4,7],
        turnToByContext:{'eating':{'health':0.01,'happiness':0.01},'decay':{'spoiled food':0.6}},
        partOf:'food',
        category:'food',
    });
    new G.Res({
        name:'meat',
        desc:'[meat,Raw meat] is the flesh and muscles taken from dead animal carcasses. While nutritous, it doesn't taste very good and is quite unhealthy due to the parasites present in it.',
        icon:[5,7],
        turnToByContext:{'eating':{'health':-0.03,'happiness':0.00,'bone':0.1},'decay':{'spoiled food':1}},
        partOf:'food',
        category:'food',
    });
    new G.Res({
        name:'cooked meat',
        desc:'[cooked meat] is delicious and full of protein, and eating it may even produce a [bone].',
        icon:[6,7],
        turnToByContext:{'eating':{'health':0.02,'happiness':0.05,'bone':0.1},'decay':{'cooked meat':0.2,'spoiled food':0.8}},
        partOf:'food',
        category:'food',
    });
    new G.Res({
        name:'cured meat',
        desc:'[cured meat] is meat seasoned, cured and dried using salt to fend off bacteria. It is tasty and can keep for months without spoiling.',
        icon:[11,6],
        turnToByContext:{'eating':{'health':0.02,'happiness':0.04,'bone':0.1},'decay':{'cured meat':0.95,'spoiled food':0.05}},
        partOf:'food',
        category:'food',
    });
    new G.Res({
        name:'seafood',
        desc:'[seafood,Raw seafood] such as fish, crabs, clams, mussels or shrimp. Less unhealthy than raw meat, but just as foul-tasting.',
        icon:[5,6],
    ...
    new G.Res({
        ...
        icon:[6,6],
        turnToByContext:{'eating':{'health':0.03,'happiness':0.00},'decay':{'cooked seafood':0.2,'spoiled food':0.8}},
        partOf:'food',
        category:'food',
    });
    new G.Res({
        name:'cured seafood',
        desc:'[cured seafood] has a nice smoky flavor and lasts extremely long.',
        icon:[12,6],
    ...
    new G.Res({
        name:'bread',
        desc:'[bread] is filling, nutritious, and delicious; for these reasons, it is often adopted as staple food by those who can produce it.',
        icon:[7,7],
        turnToByContext:{'eating':{'health':0.03,'happiness':0.05},'decay':{'spoiled food':1}},
        partOf:'food',
        category:'food',
    });
    ...
    new G.Res({
        name:'bugs',
        desc:'Various edible worms, grubs, beetles, crickets and the like. Unappetizing, but very nutritious.',
        icon:[8,11],
    ...
    new G.Res({
        name:'clay',
        desc:'Clay and clayish mud bakeable into bricks and adobe. Found by digging in damp soil and under dry river beds.',
        icon:[1,7],
    ...
    new G.Res({
        name:'brick',
        desc:'Bricks and adobe. Made from fired [clay]; can be used to construct solid walls efficiently.',
        icon:[3,8],
        partOf:'basic building materials',
        category:'build',
    });
    ...
    new G.Res({
        name:'Malachite',
        desc:'The ore of copper, stone interlaced with green stripes. Smelted into [Copper Ingot, copper ingots].',
        icon:[9,8],
        partOf:'misc materials',
        category:'build',
    });
    new G.Res({
        name:'Magnetite',
        desc:'A suprisingly magnetic stone, and the main source of iron ore. Smelted into [Iron Ingot, iron ingots]',
        icon:[10,8],
        partOf:'misc materials',
        category:'build',
    });
    new G.Res({
        name:'Calaverite',
        desc:'A rare rock used as gold ore. Smelted into [Gold Ingot, gold ingots].',
        icon:[11,8],
        partOf:'misc materials',
        category:'build',
    });
    new G.Res({
        name:'Cassiterite',
        desc:'The primary source of tin ore. Smelted into [Tin Ingot, tin ingots].',
        icon:[13,8],
        partOf:'misc materials',
        category:'build',
    });
    ...
    new G.Res({
        name:'gems',
        desc:'Rubies, sapphires, emeralds, and the occasional diamond. Used in expensive crafts.',
        icon:[7,9],
        partOf:'misc materials',
        category:'build',
    });
    ...
    new G.Res({
        name:'coal',
        desc:'An almost pure form of carbon. Known for being a valuable source of fuel during smelting, and alloying iron into steel.',
        icon:[12,8],
        partOf:'misc materials',
        category:'build',
    });
    ...
    new G.Res({
        name:'Copper Ingot',
        desc:'Copper extracted from Malachite. While too weak and soft to make tools from, it is a pretty brown color and is still useful in many crafts, and can be combined with Tin to make a much stronger alloy, bronze.',
        icon:[9,9],
        partOf:'misc materials',
        category:'build',
        });    
    new G.Res({
        name:'Tin Ingot',
        desc:'Tin extracted from Cassiterite. While too weak and soft by itself to be too useful, it can be used along with Copper to make Bronze.',
        icon:[9,9],
        partOf:'misc materials',
        category:'build',
    });
    new G.Res({
        name:'Iron Ingot',
        desc:'A strong and incredibly versatile metal, commonly used in the crafting of tools, weapons and armor.',
        icon:[10,9],
        partOf:'misc materials',
        category:'build',
    });
    new G.Res({
        name:'Bronze Ingot',
        desc:'A strong yet flexible metal about as tough as iron, made from melting tin and bronze together.',
        icon:[10,9],
        partOf:'misc materials',
        category:'build',
    });
    new G.Res({
        name:'Steel Ingot',
        desc:'The strongest metal around. Tough, near unbreakable, and used only to make the strongest weapons.',
        icon:[12,9],
        partOf:'misc materials',
        category:'build',
    });
    new G.Res({
        name:'Gold Ingot',
        desc:'The rarest metal you can find. Thousands upon thousands have died during the wars started in attempt the unending human thirst for gold. Soft and weak, but beautiful.',
        icon:[11,9],
        partOf:'misc materials',
        category:'build',
    });
    new G.Res({
        name:'Silver Ingot',
        desc:'A rare metal with little use but a beautiful look and shine. Commonly used as currency.',
        icon:[11,9],
        partOf:'misc materials',
        category:'build',
    });
    ...
    new G.Res({
        name:'knapped tools',
        desc:'"Tools" that are nothing more than sharp or blunt rocks used for purposes of cutting and bludgeoning. Primitive but effective.'+numbersInfo,
        icon:[0,9],
        displayUsed:true,
        category:'gear',
    });
    new G.Res({
        name:'stone tools',
        desc:'Simple tools made by carefully affixing stones onto sticks and allowing the handles to soak in water overnight to enlarge the handle and keep the tool itself in place. There are a variety of tools in here such as axes, hammers and knives.'+numbersInfo,
        icon:[1,9],
        displayUsed:true,
        category:'gear',
    });
